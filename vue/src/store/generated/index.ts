...
import LubtdPlanetLubtdPlanetPlanet from './lubtd/planet/lubtd.planet.planet'
...
export default { 
  ...
  LubtdPlanetLubtdPlanetPlanet: load(LubtdPlanetLubtdPlanetPlanet, 'lubtd.planet.planet'),
